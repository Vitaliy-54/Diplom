...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function login(): void
    {
        ...
        // Вместо redirectIntended с navigate: true, используем обычный редирект
        $this->redirectIntended(
            default: secure_url(route('dashboard', absolute: false)),
            navigate: false  // Изменено с true на false
        );
    }
};
?>
    ...
    <div class="auth-form">
        ...
        <form wire:submit="login" id="login-form">
            ...
            <div class="remember-me">
                ...
                <label for="remember" class="remember-label">{{ __('Запомнить меня') }}</label>
            </div>
        ...
        <div class="mt-3 text-center">
            <a href="{{ route('passkey.instruction') }}" class="text-xs text-gray-500 hover:text-indigo-400 transition-colors duration-200 inline-flex items-center gap-1">
        ...
        <div class="auth-links">
            ...
            @if (Route::has('register'))
                <a class="auth-link" href="{{ secure_url('register') }}" wire:navigate>
                    {{ __('Создать аккаунт') }}
                </a>
            @endif
        </div>
