...
@endif
                ...
                <div class="tab-content">
                    <!-- ОДНА ГЛАВНАЯ ФОРМА -->
                    <form id="calculatorForm" method="POST" action="{{ route('calculator.calculate') }}">
                        @csrf
                                ...
                                <div>
                                    ...
                                    <div class="bg-gray-200 dark:bg-gray-700 rounded-lg p-4 mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="fn" class="block w-48 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white" id="fnSelect" onchange="updateFNGrid()" {{ $viewingHistory ? 'disabled' : '' }}>
                                                @for($i = 1; $i <= 12; $i++)
                                                    @php
                                                        $selected = false;
                                                        if (old('fn') !== null) {
                                            ...
                                            <div class="grid grid-cols-3 md:grid-cols-4 gap-2" id="feGrid">
                                                ...
                                                @for($i = 0; $i < $fn; $i++)
                                                    <div>
                                                        ...
                                                        {{ $errors->has('fe.' . $i) ? 'border-red-500 dark:border-red-500' : 'border-gray-300' }}"
                                                        value="{{ old('fe.' . $i, $fe[$i] ?? '') }}"
                                                        placeholder="E{{ $i+1 }}"
                                                        {{ $viewingHistory ? 'disabled' : '' }}>
                                                        @if($errors->has('fe.' . $i))
                                    ...
                                    <div class="bg-gray-200 dark:bg-gray-700 rounded-lg p-4 mb-4">
                                        ...
                                        <div class="mb-3">
                                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Number of components:</label>
                                            <select name="j9n" class="block w-48 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white" id="j9nSelect" onchange="updateJ9NGrid()" {{ $viewingHistory ? 'disabled' : '' }}>
                                                @for($i = 1; $i <= 13; $i++)
                                                    @php
                                                        $selected = false;
                                                        if (old('j9n') !== null) {
                                            ...
                                            <div class="grid grid-cols-3 md:grid-cols-4 gap-2" id="j9eGrid">
                                                ...
                                                @for($i = 0; $i < $j9n; $i++)
                                                    <div>
                                                        ...
                                                        {{ $errors->has('j9e.' . $i) ? 'border-red-500 dark:border-red-500' : 'border-gray-300' }}" 
                                                        value="{{ old('j9e.' . $i, $j9e[$i] ?? '') }}" 
                                                        placeholder="E{{ $i+1 }}"
                                                        {{ $viewingHistory ? 'disabled' : '' }}>
                                                        @if($errors->has('j9e.' . $i))
                                                            <p class="text-xs text-red-600 dark:text-red-400 mt-1 flex items-start">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="j9c" 
                                                ...
                                                {{ $errors->has('j9c') ? 'border-red-500 dark:border-red-500 ring-1 ring-red-500' : 'border-gray-300' }}" 
                                                value="{{ old('j9c', $input['j9c'] ?? '') }}"
                                    ...
                                    <div class="bg-gray-200 dark:bg-gray-700 rounded-lg p-4 mb-4">
                                        ...
                                        <div class="mb-3">
                                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Number of components:</label>
                                            <select name="j11n" class="block w-48 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white" id="j11nSelect" onchange="updateJ11NGrid()" {{ $viewingHistory ? 'disabled' : '' }}>
                                                @for($i = 1; $i <= 13; $i++)
                                                    @php
                                                        $selected = false;
                                                        if (old('j11n') !== null) {
                                            ...
                                            <div class="grid grid-cols-3 md:grid-cols-4 gap-2" id="j11eGrid">
                                                ...
                                                @for($i = 0; $i < $j11n; $i++)
                                                    <div>
                                                        ...
                                                        {{ $errors->has('j11e.' . $i) ? 'border-red-500 dark:border-red-500' : 'border-gray-300' }}" 
                                                        value="{{ old('j11e.' . $i, $j11e[$i] ?? '') }}" 
                                                        placeholder="E{{ $i+1 }}"
                                                        {{ $viewingHistory ? 'disabled' : '' }}>
                                                        @if($errors->has('j11e.' . $i))
                                                            <p class="text-xs text-red-600 dark:text-red-400 mt-1 flex items-start">
                                                                <svg class="h-3 w-3 mr-1 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                                </svg>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="j11c" 
                                                class="block w-48 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-800 dark:border-gray-600 dark:text-white
                                                {{ $errors->has('j11c') ? 'border-red-500 dark:border-red-500 ring-1 ring-red-500' : 'border-gray-300' }}" 
                                                value="{{ old('j11c', $input['j11c'] ?? '') }}"
                                                placeholder="Enter coefficient"
                                                {{ $viewingHistory ? 'disabled' : '' }}>
                                            @if($errors->has('j11c'))
                                                <p class="text-xs text-red-600 dark:text-red-400 mt-1 flex items-center">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border-l-4 border-blue-500">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                            Original: {{ rtrim(rtrim(sprintf('%.15F', (float)$j9cOrig), '0'), '.') }}
                                        </p>
                                    </div>
                                    <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border-l-4 border-purple-500">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                            Original: {{ rtrim(rtrim(sprintf('%.15F', (float)$j11cOrig), '0'), '.') }}
                                        </p>
                                    </div>
                                </div>
                                            ...
                                            <div class="bg-white dark:bg-gray-800 rounded-lg p-3 text-center shadow-sm hover:shadow-md transition-shadow duration-200">
                                                ...
                                                @else
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 break-all">
                                                        Original: {{ rtrim(rtrim(sprintf('%.15F', (float)$kcOrig), '0'), '.') }}
                                                    </p>
                                                @endif
                                            </div>
                                        @endforeach
...
@endif
                                                                        ...
                                                                        <button onclick="editShareLink({{ $link->id }}, 
                                                                                '{{ addslashes($link->title) }}', 
                                            ...
                                            <div class="mt-3 flex flex-wrap gap-2">
                                                <a href="{{ route('calculator.history.load', $item) }}" 
                                                ...
                                                <form action="{{ route('calculator.history.delete', $item) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
...
const modal = document.createElement('div');
    ...
    function saveExperimentalDataToSession() {
        ...
        if (temps.length > 0 || values.length > 0) {
            fetch('{{ route("calculator.save-experimental") }}', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    'Content-Type': 'application/json'
    ...
    function submitOptimization() {
        ...
        setTimeout(() => {
            ...
            form.action = "{{ route('calculator.optimize') }}";
            form.method = "POST";
            form.submit();
        }, 200);
    }
    ...
    function exitHistoryView() {
        fetch('{{ route('calculator.exit-history-view') }}', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Content-Type': 'application/json'
