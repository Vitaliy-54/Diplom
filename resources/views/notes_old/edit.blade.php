<x-app-layout>
    ...
    <!-- Подключение Choices.js для выбора тегов -->
    ...
    <div class="py-6 px-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-300 dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                <div class="p-6 hidden-until-loaded">
                    <form action="{{ route('notes.update', $note) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $note->title) }}" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:border-lime-500 transition-shadow shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-lime-600 dark:focus:border-lime-600" required>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" id="description" class="hidden">{{ old('description', $note->description) }}</textarea>
                            <div id="editor"></div>
                        </div>
                        ...
                        <div class="mb-6">
                            <label for="is_public" class="flex items-center">
                                <input type="checkbox" name="is_public" id="is_public" value="1" class="w-5 h-5 rounded border-gray-300 text-lime-600 focus:ring-lime-500 shadow-sm transition-colors dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-lime-600" {{ old('is_public', $note->is_public) ? 'checked' : '' }}>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Устанавливаем данные из textarea в CKEditor
            const descriptionTextarea = document.getElementById('description');
            CKEDITOR.instances.editor.setData(descriptionTextarea.value);
