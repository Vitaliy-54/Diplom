...
class Ho3CalculationHistory extends Model
{
    use HasFactory;

    protected $table = 'ho_calculation_history';
    ...
    /**
     * Получить тип калькулятора для отображения
     */
    public function getCalculatorTypeAttribute(): string
    {
        return 'HO3+';
    }
}