...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Создание заметки')); ?>
    ...
    <div class="py-6 px-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 overflow-hidden hidden-until-loaded">
            <div class="bg-gray-300 dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden transition-all duration-200">
                <div class="p-6">
                    <form action="<?php echo e(route('notes.store')); ?>" method="POST" enctype="multipart/form-data" id="note-form">
                        <?php echo csrf_field(); ?>
                        
                        <!-- Поле "Заголовок" -->
                        <div class="mb-6">
                            <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                <?php echo e(__('Заголовок')); ?> <span class="text-red-500">*</span>
                            </label>
                            <input type="text" name="title" id="title" value="<?php echo e(old('title')); ?>"
                                placeholder="<?php echo e(__('Введите название заметки')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                            <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                <?php echo e(__('Описание')); ?> <span class="text-red-500">*</span>
                            </label>
                            <textarea name="description" id="description" rows="6" class="hidden"><?php echo e(old('description')); ?></textarea>
                            <div id="editor"><?php echo old('description'); ?></div>
                    ...
                    <div class="mb-8">
                        <div class="tags-container">
                            <label for="tags" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                <?php echo e(__('Теги')); ?> <span class="text-red-500">*</span>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" 
                                            ...
                                            onclick="toggleTag(this, <?php echo e($tag->id); ?>, '<?php echo e($tag->name); ?>')">
                                            <?php echo e($tag->name); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6">
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="text-sm text-gray-600 dark:text-gray-400">
                                        <label for="files" class="relative cursor-pointer bg-gray-300 dark:bg-gray-800 rounded-md font-medium text-lime-600 dark:text-lime-600 hover:text-lime-500 dark:hover:text-lime-500 focus-within:outline-none">
                                            <span><?php echo e(__('Загрузить файлы')); ?></span>
                                            <input id="files" name="files[]" type="file" multiple class="sr-only">
                                        </label>
                                    </div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">
                                        <?php echo e(__('PNG, JPG, PDF, DOCX, XLSX и другие')); ?>

                                    </p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">
                                        <?php echo e(__('Максимальный размер всех файлов загружаемых пользователем на сайт 150МБ')); ?>

                                    </p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">
                                        <?php echo e(__('При создании заметки, размер всех файлов в заметке не должен превышать 20МБ')); ?>
                            ...
                            <div id="file-preview" class="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 <?php echo e(count(old('files', [])) ? '' : 'hidden'); ?>"></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-6 bg-gray-200 dark:bg-gray-700 border border-gray-500 dark:border-gray-600 p-4 rounded-lg">
                            <div class="flex justify-between items-center mb-1">
                                ...
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300" id="storage-used"><?php echo e(formatFileSize(auth()->user()->getTotalStorageUsed())); ?></span>
                            </div>
                            <div class="w-full bg-gray-300 rounded-full h-2.5 dark:bg-gray-600">
                                <div id="storage-progress" class="bg-blue-600 h-2.5 rounded-full" 
                                    style="width: <?php echo e(min(100, (auth()->user()->getTotalStorageUsed() / (150 * 1024 * 1024)) * 100)); ?>%"></div>
                            </div>
                        ...
                        <div class="mb-6">
                            <label for="is_public" class="flex items-center">
                                <input type="checkbox" name="is_public" id="is_public" value="1" <?php echo e(old('is_public') ? 'checked' : ''); ?> class="w-5 h-5 rounded border-gray-300 text-blue-600 focus:ring-blue-500 shadow-sm transition-colors dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                                    <?php echo e(__('Публичная заметка (заметка будет видна всем пользователям)')); ?>
                        ...
                        <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3">
                            <a href="<?php echo e(route('notes.index')); ?>" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition duration-200">
                            ...
                            <button type="submit" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-lime-600 hover:bg-lime-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-200">
                                ...
                                <?php echo e(__('Добавить заметку')); ?>
...
const allTags = <?php echo json_encode($tags->map(fn($tag) => [
    'id' => $tag->id, 'name' => $tag->name, 'lowerName' => strtolower($tag->name)
])) ?>;
   ...
   // Проверяем, существует ли тег (без учета регистра)
    ...
    try {
        const response = await fetch('<?php echo e(route("tags.store")); ?>', {
            method: 'POST',
            headers: {
...
function updateStorageInfo() {
    ...
    const usedStorage = <?php echo e(auth()->user()->getTotalStorageUsed()); ?>;
...
<?php endif; ?><?php /**PATH C:\Users\Desktop_54\Desktop\neocalc.site_share_link_30.05\resources\views/notes/create.blade.php ENDPATH**/ ?>