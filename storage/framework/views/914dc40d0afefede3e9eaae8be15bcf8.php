        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <a href="<?php echo e(route('notes.create')); ?>"
                    ...
                    <?php echo e(__('Создать новую заметку')); ?>
            ...
            <div id="info-block" class="mb-6 p-4 bg-gray-400 dark:bg-gray-800 rounded-lg text-sm text-gray-800 dark:text-gray-300">
                <p>Хотите, чтобы ваши мысли увидели другие? Публикуйте публичные заметки. А если запись только для вас — просто уберите галочку "Публичная заметка" при создании.
                Свои записи вы всегда можете изменить или удалить. Нажмите на заголовок, чтобы прочитать заметку и оставить своё мнение. А чтобы узнать больше о другом пользователе, кликните на его имя или аватарку.</p>
            </div>
            ...
            <div class="space-y-6" id="notes-container">
                <?php echo $__env->make('notes.partials.notes_list', ['notes' => $notes], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
...
async function loadFilteredNotes() {
    ...
    try {
        ...
        const response = await fetch(`<?php echo e(route('notes.index')); ?>?${params}`, {
            headers: {
    ...
    try {
        ...
        // Создаем URL и принудительно используем HTTPS
...
<?php endif; ?><?php /**PATH C:\Users\Desktop_54\Desktop\neocalc.site_share_link_30.05\resources\views/notes/index.blade.php ENDPATH**/ ?>